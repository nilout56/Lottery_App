...
const Footer = () => {
  return (
<footer className="bg-gradient-to-r from-primary via-[#49515F] to-primary border-t-2 border-accent border-opacity-5">
  <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
      <img src="/assets/logome.jpeg" className="mr-5 h-6 sm:h-9 rounded-full overflow-hidden w-50 h-50 " alt="logo" />
